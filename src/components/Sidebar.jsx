...
export default function Sidebar() {
  ...
  return (
    <aside className="z-20 hidden w-56 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
