...
import logo from "./logo-dramaKu.png"; // Sesuaikan path gambar
import imageLight from "./m.avif"; // Sesuaikan path gambar
import imageDark from "./assets/img/login-office-dark.jpeg"; // Sesuaikan path gambar
          ...
          <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              <div className="w-full flex justify-center">
                <img src={logo} className="w-56" alt="Logo Dramaku" />
              </div>
